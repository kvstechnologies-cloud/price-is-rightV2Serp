/**
 * File type detection utility for the audit system
 * Maps MIME types and filenames to display-friendly type names
 */

export function getDisplayType(mimeType?: string, filename?: string): string {
 ...
 */
export function determineJobType(mimeType?: string, filename?: string): 'CSV' | 'EXCEL' | 'IMAGE' | 'UNKNOWN' {
 ...
 */
export function getFileTypeForDB(mimeType?: string, filename?: string): 'csv' | 'xlsx' | 'image' {
